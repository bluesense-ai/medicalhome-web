        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 flex-grow">
          <div className="flex-1 relative">
            <select
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-md text-gray-600 bg-white appearance-none cursor-pointer select-font-size"
            >
          ...
          <div className="flex-1 relative">
            ...
            >
              ...
              <option value="Hope Health Center">Hope Health Center</option>
            </select>
            <div className="absolute inset-y-0 right-3 flex items-center pointer-events-none">
              <img
                src="/Icons/Chevron down.svg"
