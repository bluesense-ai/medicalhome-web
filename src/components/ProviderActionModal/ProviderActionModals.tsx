...
interface ActionModalProps {
  ...
  modalType: 'save' | 'delete' | 'finish' | 'deleteConfirm' | 'reassignPatients'|'deleteService';
}
  ...
  const getModalContent = () => {
    ...
    if (modalType === 'finish') {
      ...
      return {
        ...
        message: 'When you click on yes, you will be deleting this person from the waitlist.',
    ...
    else if (modalType === 'deleteService') {
      
      return {
        bgColor: 'bg-[#FEECEC]',
        title: 'Are you sure you want to delete this service?',
        titleColor: 'text-[#A30E0E]',
        message: 'When you click on yes, you will be deleting this service from the provider services list.',
        borderColor: 'border-[#A30E0E]',
        cancelText: "Don't delete them",
        cancelColor: 'text-[#016C9D]',
        confirmText: "Yes, I'm sure",
